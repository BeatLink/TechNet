            ...
            zfspool = {
                ...
                datasets = {
                    root = {                                            # The dataset for the root filesystem mounted at /
                        ...
                        postCreateHook = ''
                            zfs snapshot zfspool/root@blank             # This takes a snapshot of the blank pool. Every boot, the system will rollback to this snapshot
                        '';     
                    };
                    ...
                    home = {                                            # The dataset for the user profiles mounted at /home
                        ...
                        postCreateHook = ''
                            zfs snapshot zfspool/home@blank             # This takes a snapshot of the blank pool. Every boot, the system will rollback to this snapshot
                        '';     
                    };
                };
            };
