...
let
    ...
    theme = "${halonLmms}/share/lmms/themes/Halon-Light";
in
{
    environment = {
        ...
        sessionVariables.LMMS_THEME_PATH = theme;
    ...
    home-manager.users.beatlink.xdg.dataFile."lmms/themes/Halon".source = theme;
}
