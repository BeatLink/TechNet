# Root Drive #########################################################################################################################################
#
# Points disko at the SSD holding the system and carries the host ID the ZFS module still asks for; the bridge's quirks live in hardware-configuration.nix.
#
